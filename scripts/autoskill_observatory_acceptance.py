...
ACCEPTANCE_CRITERIA: tuple[ObservatoryItem, ...] = (
    ...
    ObservatoryItem("21.23", "Autonomy pages expose evidence fidelity, raw-vault policy state, LLM semantic adjudications, deterministic admissibility checks, threshold policy versions, fallback ladders, threshold-deadlock findings, replay/canary corpus episodes, and administrative escalations.", ("semantic_adjudication, autonomy_orchestrator, replay_corpus, administrative_escalation stations", "/admin/api/v1/adjudications", "/admin/api/v1/autonomy/decisions", "/admin/api/v1/autonomy/policies", "/admin/api/v1/autonomy/threshold-deadlocks", "/admin/api/v1/escalations", "broker replay corpus UI/API")),
