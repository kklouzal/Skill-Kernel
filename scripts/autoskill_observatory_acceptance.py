...
ACCEPTANCE_CRITERIA: tuple[ObservatoryItem, ...] = (
    ObservatoryItem("21.1", "The split Observatory container serves the web UI and owns the /admin API/live surfaces at the same base path.", ("sidecar/autoskill/observatory_main.py", "containers/observatory/Dockerfile", "sidecar/autoskill/observatory/vite.config.ts")),
    ...
    ObservatoryItem("21.19", "Topology pages show create/improve/compose/decompose lineage and routing relationships.", ("/admin/api/v1/topology", "topology stations and operation metrics in services/observatory.py", "governance.evolution_transactions.metrics topology transaction review")),
