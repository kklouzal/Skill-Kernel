...
7. Build deterministic staged writer apply/rollback on top of transaction items and provenance traversal.
...
- Revocation traversal now previews impacted derived artifacts, but rollback execution and per-object invalidation/revoke handlers are still pending.
